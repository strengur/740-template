...
<section class="intro" id="kynning">
	<div class="content three-column">
		...
		<div class="intro-content-row-one">
			<h4>
				<img src="<?php bloginfo('template_directory');?>/images/740-intro-img-new.png" alt="Hringlaga útlínumynd af vefsíðu"><br><br>
				Vefsíðugerð
			</h4>
...
<!-- 					<center><button>Smelltu hér</button></center> -->
		...
		<div class="intro-content-row-two">
			<h4>
				<img src="<?php bloginfo('template_directory');?>/images/740-intro-img-online.png" alt="Hringlaga mynd af innkaupakerru"><br><br>
				Netverslun
			</h4>
			<div class="none-mobile-hr"><hr></div>
		...
		<div class="intro-content-row-three">
			<h4>
				<img src="<?php bloginfo('template_directory');?>/images/740-intro-img-nytt-utlit.png" alt="Orðin NÝTT ÚTLIT inn í hring"><br><br>
				Útlitsbreyting
			</h4>
			<div class="none-mobile-hr"><hr></div>
